...
!function (a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.3.4", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function () {
        ...
        function x(c) {
            ...
            if (b.opts.fullPage) {
                var e = u(d, "body") || (d.indexOf("<body") >= 0 ? "" : d), f = v(d, "body"), g = u(d, "head") || "<title></title>", h = v(d, "head"), i = a("<div>").append(g).find("base, link, meta, noscript, script, style, template, title").remove().end().html().trim();
        ...
        function y(a, c) {
            ...
            if (!b.opts.useClasses && !c) {
                for (e = 0; e < b.doc.styleSheets.length; e++) {
                    ...
                    if (i)for (var l = 0, m = i.length; m > l; l++)if (i[l].selectorText && i[l].style.cssText.length > 0) {
                        ...
                        for (var p = 0; p < n.length; p++) {
                            !n[p].getAttribute("fr-original-style") && n[p].getAttribute("style") ? (n[p].setAttribute("fr-original-style", n[p].getAttribute("style")), g.push(n[p])) : n[p].getAttribute("fr-original-style") || g.push(n[p]), h[n[p]] || (h[n[p]] = {});
                            for (var q = 1e3 * j + f(i[l].selectorText), s = i[l].style.cssText.split(";"), t = 0; t < s.length; t++) {
                                var u = s[t].trim().split(":")[0];
                                h[n[p]][u] || (h[n[p]][u] = 0, (n[p].getAttribute("fr-original-style") || "").indexOf(u + ":") >= 0 && (h[n[p]][u] = 1e4)), q >= h[n[p]][u] && (h[n[p]][u] = q, s[t].trim().length && (n[p].style[u.trim()] = s[t].trim().split(":")[1].trim()))
                            }
                        }
                    }
                }
                for (e = 0; e < g.length; e++)if (g[e].getAttribute("class") && (g[e].setAttribute("fr-original-class", g[e].getAttribute("class")), g[e].removeAttribute("class")), (g[e].getAttribute("fr-original-style") || "").trim().length > 0)for (var v = g[e].getAttribute("fr-original-style").split(";"), p = 0; p < v.length; p++)v[p].indexOf(":") > 0 && (g[e].style[v[p].split(":")[0].trim()] = v[p].split(":")[1].trim())
            }
        ...
        function o(c, d) {
            if (b.selection.isCollapsed()) {
                ...
                var j = b.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, k = {"class": "fr-unprocessed"};
                for (d && (k.style = c + ": " + d + ";"), g(j, "span", k), b.$el.find(".fr-marker + .fr-unprocessed").each(function () {
                    ...
                    if (q.length) {
                        ...
                        var w = r + b.node.openTagString(a(q.get(0)).clone().css(c, d || "").get(0)) + u + l.css(c, "").get(0).outerHTML + t + "</span>" + s;
        ...
        function o(c, d, e) {
            ...
            if (h && "BLOCKQUOTE" == h.tagName)return f(c, h) ? (g = b.html.defaultTag(),
                g ? a(h).after("<" + g + ">" + a.FE.MARKERS + "<br></" + g + ">") : a(h).after(a.FE.MARKERS + "<br>"), a(c).remove(), !1) : (q(c, d, e), !1);
            if (null == h)g = b.html.defaultTag(), g && b.node.isElement(c.parentNode) ? a(c).replaceWith("<" + g + ">" + a.FE.MARKERS + "<br></" + g + ">") : a(c).replaceWith("<br/>" + a.FE.MARKERS + "<br/>"); else {
                var i = c, j = "";
        ...
        function i() {
            ...
            for (var d = 0; d < c.length; d++) {
                var e = n(c[d]) || "";
                if (!(e !== n(b(n("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) && e.indexOf(m, e.length - m.length) < 0 && [n("9qqG-7amjlwq=="), n("KA3B3C2A6D1D5H5H1A3=="), n("QzbzvxyB2yA-9m==")].indexOf(m) < 0)) {
                    a.ul = !1;
                    break
                }
            }
        ...
        function d(c) {
            ...
            var d = c.which, e = -1 != navigator.userAgent.indexOf("Mac OS X") ? c.metaKey : c.ctrlKey, f = (c.shiftKey ? "^" : "") + (c.altKey ? "@" : "") + d;
        ...
        function d(c, d) {
            ...
            b.$tooltip.css("position", ""), b.$tooltip.css("left", e), b.$tooltip.css("top", g), "static" != a(b.o_doc).find("body").css("position") ? (b.$tooltip.css("margin-left", -a(b.o_doc).find("body").offset().left), b.$tooltip.css("margin-top", -a(b.o_doc).find("body").offset().top)) : (b.$tooltip.css("margin-left", ""), b.$tooltip.css("margin-top", ""))
        }
